...
//	a service
int32_t	fib_processor::findServiceIdwithName (const QString &s) {
int16_t i;
...
void	fib_processor::dataforDataService (const QString &s,
...
void	fib_processor::dataforAudioService (const QString &s,
