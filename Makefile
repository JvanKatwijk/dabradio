...
# Project:  dab3.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile dab3.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DGITHASH=\"------\" -D__THREADED_BACKEND -DPRESET_NAME -DHAVE_RTLSDR -DHAVE_SDRPLAY -DHAVE_AIRSPY -DSSE_AVAILABLE -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
DISTDIR = /usr/shared/sdr-j-development/systems/dab3/.tmp/dabradio-1.01.0.0
LINK          = g++
LFLAGS        = -g -Wl,-O1
...
$(TARGET): ui_filereader-widget.h ui_technical_data.h ui_dabradio.h ui_rtlsdr-widget.h ui_sdrplay-widget.h ui_airspy-widget.h $(OBJECTS)  
	@test -d linux-bin/ || mkdir -p linux-bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: dab3.pro ../../../../lib64/qt5/mkspecs/linux-g++/qmake.conf ../../../../lib64/qt5/mkspecs/features/spec_pre.prf \
		../../../../lib64/qt5/mkspecs/common/unix.conf \
		../../../../lib64/qt5/mkspecs/common/linux.conf \
		../../../../lib64/qt5/mkspecs/common/sanitize.conf \
		../../../../lib64/qt5/mkspecs/common/gcc-base.conf \
...
compiler_uic_make_all: ui_filereader-widget.h ui_technical_data.h ui_dabradio.h ui_rtlsdr-widget.h ui_sdrplay-widget.h ui_airspy-widget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_filereader-widget.h ui_technical_data.h ui_dabradio.h ui_rtlsdr-widget.h ui_sdrplay-widget.h ui_airspy-widget.h
...
spectrum-handler.o: dab-scope/spectrum-handler.cpp dab-scope/spectrum-handler.h \
		includes/dab-constants.h \
		../../../../include/qt5/QtCore/QString \
		../../../../include/qt5/QtCore/qstring.h \
		../../../../include/qt5/QtCore/qchar.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o spectrum-handler.o dab-scope/spectrum-handler.cpp
