...
CC            = gcc
CXX           = g++
DEFINES       = -DGITHASH=\"81d0b6a\" -D__THREADED_BACKEND -DPRESET_NAME -DHAVE_RTLSDR -DHAVE_SDRPLAY -DHAVE_AIRSPY -DSSE_AVAILABLE -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
