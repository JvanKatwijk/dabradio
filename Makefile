...
CC            = gcc
CXX           = g++
DEFINES       = -DGITHASH=\"196d1fc\" -D__THREADED_BACKEND -DPRESET_NAME -DHAVE_RTLSDR -DHAVE_SDRPLAY -DHAVE_AIRSPY -DSSE_AVAILABLE -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
DISTDIR = /usr/shared/sdr-j-development/systems/newradio/.tmp/dabradio-1.01.0.0
LINK          = g++
LFLAGS        = -flto -Wl,-O1
LIBS          = $(SUBLIBS) -lfftw3f -lusb-1.0 -ldl -lportaudio -lz -lsndfile -lsamplerate -lfaad -lqwt-qt5 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
$(TARGET): ui_filereader-widget.h ui_dabradio.h $(OBJECTS)  
...
moc_radio.cpp: includes/dab-constants.h \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/newradio -I/usr/shared/sdr-j-development/systems/newradio -I/usr/shared/sdr-j-development/systems/newradio -I/usr/shared/sdr-j-development/systems/newradio/src -I/usr/shared/sdr-j-development/systems/newradio/includes -I/usr/shared/sdr-j-development/systems/newradio/includes/ofdm -I/usr/shared/sdr-j-development/systems/newradio/includes/backend -I/usr/shared/sdr-j-development/systems/newradio/includes/backend/viterbi_768 -I/usr/shared/sdr-j-development/systems/newradio/includes/backend/audio -I/usr/shared/sdr-j-development/systems/newradio/includes/backend/data -I/usr/shared/sdr-j-development/systems/newradio/includes/output -I/usr/shared/sdr-j-development/systems/newradio/includes/various -I/usr/shared/sdr-j-development/systems/newradio/devices -I/usr/shared/sdr-j-development/systems/newradio/devices/rawfiles -I/usr/shared/sdr-j-development/systems/newradio/devices/wavfiles -I/usr/local/include -I/usr/local/include -I/usr/include/qt4/qwt -I/usr/include/qt5/qwt -I/usr/include/qt4/qwt -I/usr/include/qwt -I/usr/local/qwt-6.1.4-svn -I/usr/shared/sdr-j-development/systems/newradio/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/newradio/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/newradio/devices/airspy-handler -I/usr/shared/sdr-j-development/systems/newradio/devices/airspy-handler/libairspy -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include radio.h -o moc_radio.cpp
...
moc_service-list.cpp: ../../../../include/qt5/QtWidgets/QWidget \
		../../../../include/qt5/QtWidgets/qwidget.h \
		../../../../include/qt5/QtWidgets/qtwidgetsglobal.h \
		../../../../include/qt5/QtGui/qtguiglobal.h \
		../../../../include/qt5/QtCore/qglobal.h \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/newradio -I/usr/shared/sdr-j-development/systems/newradio -I/usr/shared/sdr-j-development/systems/newradio -I/usr/shared/sdr-j-development/systems/newradio/src -I/usr/shared/sdr-j-development/systems/newradio/includes -I/usr/shared/sdr-j-development/systems/newradio/includes/ofdm -I/usr/shared/sdr-j-development/systems/newradio/includes/backend -I/usr/shared/sdr-j-development/systems/newradio/includes/backend/viterbi_768 -I/usr/shared/sdr-j-development/systems/newradio/includes/backend/audio -I/usr/shared/sdr-j-development/systems/newradio/includes/backend/data -I/usr/shared/sdr-j-development/systems/newradio/includes/output -I/usr/shared/sdr-j-development/systems/newradio/includes/various -I/usr/shared/sdr-j-development/systems/newradio/devices -I/usr/shared/sdr-j-development/systems/newradio/devices/rawfiles -I/usr/shared/sdr-j-development/systems/newradio/devices/wavfiles -I/usr/local/include -I/usr/local/include -I/usr/include/qt4/qwt -I/usr/include/qt5/qwt -I/usr/include/qt4/qwt -I/usr/include/qwt -I/usr/local/qwt-6.1.4-svn -I/usr/shared/sdr-j-development/systems/newradio/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/newradio/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/newradio/devices/airspy-handler -I/usr/shared/sdr-j-development/systems/newradio/devices/airspy-handler/libairspy -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include service-list.h -o moc_service-list.cpp
...
compiler_uic_make_all: ui_filereader-widget.h ui_dabradio.h
compiler_uic_clean:
	-$(DEL_FILE) ui_filereader-widget.h ui_dabradio.h
...
service-list.o: service-list.cpp ../../../../include/qt5/QtCore/QFile \
		../../../../include/qt5/QtCore/qfile.h \
		../../../../include/qt5/QtCore/qfiledevice.h \
		../../../../include/qt5/QtCore/qiodevice.h \
		../../../../include/qt5/QtCore/qglobal.h \
		...
		includes/various/band-handler.h \
		includes/various/text-mapper.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o service-list.o service-list.cpp
...
moc_service-list.o: moc_service-list.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_service-list.o moc_service-list.cpp
